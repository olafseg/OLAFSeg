...
class DeepLabFactored(nn.Module):
    def __init__(self, num_anim_classes, num_inanim_classes, backbone='resnet101', output_stride=16,
        ...
        self.lr_decoder = build_decoder_factored(3, backbone, BatchNorm)
        self.fb_decoder = build_decoder_factored(3, backbone, BatchNorm)
...
model = DeepLabFactored(backbone='resnet101', num_anim_classes=24, num_inanim_classes=29)


obj_model.load_state_dict(torch.load('/home2/pranavgupta77/obj.pth')['state_dict'])
model.load_state_dict(torch.load('/ssd_scratch/cvit/pranav.g/float/ckpt/201_combined_v2_104.pth'))
...
output_dir = '/home2/pranavgupta77/codes/201/wacv/outputs/201_combined_v2/'
...
print('Final With IZR', valid_miou_avg.avg, valid_alliou_avg.Mean_Intersection_over_Union())
print('Final With IZR', valid_miou_avg.sqiou, valid_alliou_avg.Mean_Intersection_over_Union_PerClass())
