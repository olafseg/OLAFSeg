...
ckpt_path = '/ssd_scratch/cvit/pranav.g/float/ckpt/108_combined_v2_'

"""PATH = '/home/pranavmicro7/wacv/data/'
ckpt_path = '/home/pranavmicro7/wacv/108/weights/108_combined_v1.1/'"""
...
class ResNet(nn.Module):
    ...
    def _load_pretrained_model(self):
        ...
        #assign average of first 3 channels to the last channel
...
def aggregate_parts_to_classes(num_classes=108, animate=True):
    ...
    #                   Plate (7), Screen (8), Pot (9), Plant (10), Window (11),
    #                   Bottle Cap (12) Body (13), Saddle (14), Handlebar(15), Chainwheel (16),
    #                   Side (17), Roof (18), Mirror (19), Door (20), Head (21), Head Side (22),
    #                   Head Roof (23), Coach(24), Coach Side (25), Coach Roof (26)
        ...
        map_pc[73] = 2 # Motorbike
        map_pc[74] = 15
        map_pc[75] = 14
        map_pc[76] = 6

        map_pc[89] = 9 # Potted plant
        map_pc[90] = 10
...
class SegmentationDataset(Dataset):
    def __init__(self, folder, mode='train',
                 input_shape=(513, 513), num_classes=108):
...
for epoch in range(num_epochs):
    ...
    torch.save(model.module.state_dict(), ckpt_path + str(epoch) + '.pth')
